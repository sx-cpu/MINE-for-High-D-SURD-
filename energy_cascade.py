...
if __name__ == "__main__":
    ...
    for subset in subsets:
        ...
        save_path = f'logs/energy_cascade/tar{target_var}_energycascade_{subset}_{ts0}.png'
    ...
    savepath = f"./results/MI_results/energycascade_MI_results_target_{target_var}_{ts}.npy"
